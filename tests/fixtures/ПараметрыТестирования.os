...
Функция Вывод_АппаратныеКлючиСписок()
    ...
    ВыводКоманды = ВозвращаемыеЗначения["АппаратныеКлючи"];

    Возврат ОписаниеВыводаКоманды(ПараметрыКоманды, ВыводКоманды);

КонецФункции // Вывод_АппаратныеКлючиСписок()
...
Процедура Инициализация()
    ...
    ПараметрыМонитора.Вставить("АппаратныеКлючи", Новый Структура("Список"));
    ПараметрыМонитора.АппаратныеКлючи.Список = Вывод_АппаратныеКлючиСписок();
